...
<body>
    ...
    <div id="main">
        ...
        <div class="text-center">
            ...
            <a href="http://cursos.egp.ce.gov.br/mod/quiz/view.php?id=1897&forceview=1" class="btn btn-primary" role="button" aria-pressed="true">Realizar Atividade Avaliativa 06 <i class="fa fa-chevron-right"></i></a>
        </div>
