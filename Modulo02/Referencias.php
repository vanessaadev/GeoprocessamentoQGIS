            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <div class="page-title">
                        ...
                        <p>Parabéns! Você concluiu o <strong class="TextoBold">Módulo 02</strong> do curso de <strong class="TextoBold">Cartografia Básica e Introdução ao Geoprocessamento com QGIS</strong>. Agora você já pode responder a avaliação do módulo. Clique em “<strong class="TextoBold">Realizar Avaliação</strong>”. Boa sorte e até o próximo módulo!</p>
