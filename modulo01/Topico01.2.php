                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            ...
                            <ol class="none Texto">
                                ...
                                <br><li class="wow fadeInLeft" data-wow-delay="0.6s">2. <strong><u>Painel Navegador:</u></strong> através desse painel é possível localizar rapidamente e ter acesso a diversos locais, servidores ou fontes de dados on-line. Você pode fechar ou encolher uma pasta usando a “setinha” antes da pasta onde se encontram os arquivos. Você também pode arrastar e soltar em um lugar facilmente;</li>
                                <br><li class="wow fadeInLeft" data-wow-delay="0.9s">3. <strong><u>Painel de Camadas:</u></strong> no painel de camadas ficam localizados todos os arquivos abertos no QGIS;</li>
                            </ol>
                            ...
                            <center>
                                <p><strong>Barra de Ferramentas do Projeto</strong></p>
                            </center>
                            <div class="text-center">
                            ...
                            <br>
                            <center>
                                <p><strong>Ferramentas de Mapa de Navegação</strong></p>
                            </center>
                            <div class="text-center">
                            ...
                            <br>
                            <center>
                                <p><strong>Ferramentas de Atributos</strong></p>
                            </center>
                            <div class="text-center">
                            ...
                            <br>
                            <center>
                                <p><strong>Ferramentas de Digitalização</strong></p>
                            </center>
                            <div class="text-center">
                            ...
                            <br>
                            <center>
                                <p><strong>Ferramentas de Rótulos</strong></p>
                            </center>
                            <div class="text-center">
                            ...
                            <br>
                            <center>
                                <p><strong>Ferramentas de Gerenciamento de Camadas</strong></p>
                            </center>
                            <div class="text-center">
