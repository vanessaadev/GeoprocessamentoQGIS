                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <ul class="none">
                            ...
                            <li class=" wow fadeInLeft" data-wow-delay="0.6s"><strong>2. Instalados:</strong> Este guia mostra os plug-ins que já estão instalados no QGIS. Para ativar/desativar um plugin, basta marcar/desmarcar o botão de alternância ao lado dele;</li>
                            <li class=" wow fadeInLeft" data-wow-delay="0.9s"><strong>3. Não instalados:</strong> Esta guia contém uma lista de todos os plugins disponíveis que não estão instalados em seu QGIS.</li>
                        </ul>
                        ...
                        <ul class="none">
                            ...
                            <li class=" wow fadeInLeft" data-wow-delay="0.6s"><strong>5. Novo:</strong> Esta guia contém novos complementos que podem ser instalados;</li>
                            <li class=" wow fadeInLeft" data-wow-delay="0.9s"><strong>6. Inválido:</strong> Esta guia é mostrada quando há plugins instalados que estão quebrados ou incompatíveis com sua versão do QGIS. Se você clicar em um plugin nesta guia, serão mostradas as informações sobre a possível causa da invalidez;</li>
                            <li class=" wow fadeInLeft" data-wow-delay="1.0s"><strong>7. Instalar a partir do ZIP:</strong> nesta guia, se você tiver um plugin compactado e desejar realizar a instalação manual, basta selecionar o arquivo na pasta que ele estiver salvo e clicar no botão <strong>instalar complemento</strong>. Esta funcionalidade não se aplica à maioria dos plugins, que são disponibilizados nas guias 1 e 3;</li>
                            <li class=" wow fadeInLeft" data-wow-delay="1.3s"><strong>8. Opções:</strong> esta guia permite definir com que frequência as atualizações serão verificadas e se usar plugins experimentais ou obsoletos. Embora não seja recomendado usar plugins experimentais para fins de produção, você ainda pode ativar a opção de explorar toda a gama de ferramentas disponíveis. Por padrão, apenas o QGIS <em>Official Plugin Repository</em> está conectado, mas você pode conectar repositórios adicionais se os conhecer clicando no botão <strong>Adicionar</strong>. </li>
                        </ul><br>

                        <p>Neste vídeo serão instalados os seguintes complementos: SCP, Elevation Profile, QGis Threejs.</p>
